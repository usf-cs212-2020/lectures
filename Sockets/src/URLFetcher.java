...
/**
 * Demonstrates using a {@link URLConnection} to fetch the headers and content from a URL on the
 * web.
 */
public class URLFetcher {
   ...
   * @see #fetchURL(URL)
   */
  public static Map<String, List<String>> fetchURL(String url)
   ...
   *
   * @param args unused
   * @throws Exception if unable to fetch URL properly
   */
