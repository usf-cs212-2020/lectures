...
public class CastDemo {
  ...
  /**
   * This method demonstrates simple upcasting and downcasting. Note that even though {@link Number}
   * is an abstract class, we can still use it as an identifier (or reference).
   */
  ...
  /**
   * This method demonstrates one possible use for upcasting---getting around the restriction that
  ...
  /**
   * This method demonstrates that since every class implicitly inherits from {@link Object}, we can
   * always upcast to the {@link Object} class.
   */
  ...
  /**
   * This method demonstrates that we can also do this if the classes share the same interface.
   */
  ...
  /**
   * This method is part of the {@link #interfaceDemo()} example, and shows how generalized methods
   * can be created that will work on multiple subclasses.
   *
   ...
   * collections---allowing the implementation class to change without affecting the rest of the
   * code.
   */
  public static void setDemo() {
    ...
    /*
     * Using upcasting prevents you from using any methods specific to, for example, TreeSet, making
     * your code more generalized.
     */
  }

  /**
   * This method runs all of the examples at once. You can comment out each demo to run one at a
   * time if you want.
   *
   * @param args unused
   */
