...
/**
 * This class demonstrates the Generic syntax, and how to use Generic types to improve the
...
public class GenericTypesDemo {
  ...
  public static void rawDemo() {
    /*
     * You can use a "raw type" in your code, but it will generate quite a few warnings.
     */
    ...
    /*
     * The warnings are there for a good reason. Without the type specified, we could place items in
     * our list that don't match.
     */
    // list.add(Double.valueOf(3.14));

    /*
     * And, when we access the elements in our list, the reference will always be an Object. We have
     * to downcast to access the actual String type, and this could cause runtime exceptions.
     */
  ...
  public static void listDemo() {
    /*
     * Instead of raw types, use the Generic types notation to specify what type of object this
     * ArrayList should store.
     *
     * You can initialize as follows:
     *
     * ArrayList<String> list = new ArrayList<String>();
     *
     * Starting in Java 7, you can simplify this to the line below. You can skip re-specifying the
     * type in the < > angle brackets if Java can infer the type.
     */
    ...
    /*
     * And, we no longer need to downcast since the ArrayList knows what type of objects it is
     * storing!
     */
  ...
  /**
   * This method demonstrates how we can use Generic types in a method to make that method more
   * generalized. If we use upcasting and return an Object type, it has to be downcast later on back
   * to its original type. This way, we always return the object in its own type without forcing
   ...
   *
   * @see #methodDemo()
   * @see <a href="https://en.wikipedia.org/wiki/Reservoir_sampling">Reservoir Sampling
   *      (Wikipedia)</a>
   */
  ...
  /**
   * This method demonstrates how we can replace restrictions on the Generic type if necessary.
   *
  ...
  /**
   * This method demonstrates how we can create generalized classes using Generic types as well,
   * allowing the developer to specify the type of object or objects that should be used by that
   * class.
   *
   * @see Pair
   */
  ...
  /**
   * This method demonstrates how to use wildcards to bound the generic type to a {@link Number},
   * and use upcasting.
   *
  ...
  public static void wildcardDemo() {
    ...
    /*
     * With just upcasting alone, we will get compile errors when we try the following line. This is
     * because while Integer is a subclass of Number, List<Integer> is *NOT* a subclass of
     * List<Number>. Since they are not subclasses of each other, upcasting will fail.
     */
