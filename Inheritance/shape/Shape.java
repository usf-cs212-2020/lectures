...
public abstract class Shape {
  ...
  /**
   * Calculates and returns the area of the shape. Abstract, so it must be implemented by
  ...
  /**
   * Returns a String representation of this object. Note the @Override annotation, indicating we
   * are overriding a method provided by a superclass. You should always use this annotation when
   * appropriate to avoid bugs!
   *
