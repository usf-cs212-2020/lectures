...
/**
 * This class demonstrates the {@link Comparable} and {@link Comparator} interfaces and how to use
 * these elements to change how a list of objects is sorted.
 */
public class GadgetSortDemo {

  // What should be the type of parameter? List? Set? Collection?
  /**
   * Able to print to console any {@link Iterable} of {@link Gadget} objects. Used to debug.
   *
  ...
  /**
   * Demonstrates how to sort the {@link ArrayList} of {@link Gadget} objects using the
   * {@link Comparable} and {@link Comparator} interfaces and the
