...
/**
 * A simple example of using Jetty and servlets to track the number of visitors to a web page,
 * demonstrating that this code is run in a multi-threaded setting.
 */
public class VisitServer {
  ...
  /**
   * Increments the number of visits to this website and outputs the current value.
   */
