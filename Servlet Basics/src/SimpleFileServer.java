...
/**
 * A simple example of using Jetty and servlets to both serve static resources and dynamic content.
 */
public class SimpleFileServer {
  ...
  /**
   * Sets up a Jetty server with both a resource and servlet handler. Able to respond with static
   * and dynamic content.
   *
   * @param args unused
