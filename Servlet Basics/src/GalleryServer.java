...
/**
 * Demonstrates one way to serve both dynamic and static resources. Requires a local web/foto
 * directory with several jpg images to function properly.
 */
public class GalleryServer {
  ...
  /**
   * Sets up a Jetty server with a resource, context, and servlet context handler to respond to
   * requests for both dynamic and static resources.
   *
   * @param args unused
  ...
  /**
   * Automatically adds all of the images found in the web/foto subdirectory to a gallery page.
   */
