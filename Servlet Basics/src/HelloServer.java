...
/**
 * Demonstrates the danger of using user-input in a web application, especially regarding cross-site
...
public class HelloServer {
  ...
  /**
   * Reads user name passed via a GET query string and uses that input to say hello to the user.
   * Demonstrates XSS attacks caused by this approach. THIS IS AN EXAMPLE OF WHAT **NOT** TO DO!
   */
  public static class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      /*
       * This can lead to a cross-site scripting attack! NEVER directly use input from the user in
       * your webpage.
       *
       * JavaScript:
       ...
       *
       * Some browsers are smart enough to not load Javascript found within the URL request... so
       * these examples may no longer work.
       */
