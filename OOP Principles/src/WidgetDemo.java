...
public class WidgetDemo {
  ...
  public static void main(String[] args) {
    /*
     * STATIC - Since this method is static, we can access it when there are no instances created.
     * That is why static members are initialized at declaration!
     */
    ...
    /*
     * INSTANCE - The following are actual objects, or instances of the Widget class. They have
     * their own instance attributes, but share class attributes.
     *
     * DECLARATION - We have declared the identifiers for these elements, but memory has not yet
     * been reserved. Any access will result in a null pointer exception.
     */
    Widget widget1;
    Widget widget2;

    /*
     * DEFINITION - We are reserving memory with the "new" keyword, creating actual objects with
     * initial values.
     */
