/**
 * This class demonstrates the impact different types of lock/key objects have on whether multiple
 * threads may run synchronized blocks of code at the same time. While some of these approaches may
 * lead to fewer objects or fewer bugs, they may not advised from a security standpoint. Just keep
 * in mind the lock object used has implications beyond synchronization!
 *
 * @see <a href= "https://wiki.sei.cmu.edu/confluence/pages/viewpage.action?pageId=88487666">SEI
