...
public class RegexGroups {
  ...
  public static void main(String[] args) {
     ...
     *
     * The (?i) at the start does not contribute to group count. Any group that starts with a ?
     * question mark is a non-capturing group.
     *
     * The first group, i.e. group 1, is the match for the first (.+).
     *
     * The @ at sign will not appear in any group (except group 0, which is the entire match).
     *
     * The second group is the match for (.+\\.(.+)) after the @ at sign.
     *
     * The third group is the nested group (.+) inside the second group. It will NOT include the
     * last period (i.e. \\.).
     */
