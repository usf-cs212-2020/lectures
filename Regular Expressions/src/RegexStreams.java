...
/**
 * Demonstrates how to use streams and lambda functions with regular expressions to replace
 * substrings.
 */
public class RegexStreams {
  ...
  /**
   * Collects a set of simple HTML tags found using regular expressions and a stream of
  ...
  /**
   * Filters out lines that contain any HTML tags using a regular expression as a predicate.
   *
