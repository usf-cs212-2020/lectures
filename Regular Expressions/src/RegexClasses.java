...
public class RegexClasses {
  ...
  public static void main(String[] args) {
    ...
    /*
     * As demonstrated above, there are several ways to specify equivalent character classes.
     */
    ...
    /*
     * Notice in digit output above that each digit 7 and 6 are individual matches.
     */
    ...
    /*
     * Notice difference between word and non-whitespace characters above is whether the symbols
     * match.
     */
    ...
    /*
     * Notice difference between whitespace and non-word characters above is whether the symbols
     * match.
     */
