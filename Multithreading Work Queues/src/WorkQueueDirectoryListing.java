...
/**
 * This class demonstrates a slightly better option than {@link MultithreadedDirectoryListing} for
 * making a multithreaded version of {@link RecursiveDirectoryListing}.
 *
 * Note: With a tweak to our work queues (moving the pending variable there), we can avoid needing
 * the task manager class entirely!
 */
