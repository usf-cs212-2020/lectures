...
/**
 * A simple work queue implementation based on the IBM developerWorks article by Brian Goetz. This
 * version uses locks and conditions from the concurrent package. However, it is still up to the
 * user of this class to keep track of whether there is any pending work remaining.
 *
