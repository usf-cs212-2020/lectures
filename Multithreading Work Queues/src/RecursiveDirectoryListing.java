...
public class RecursiveDirectoryListing {
  ...
  /**
   * Returns a directory listing for the given path. The original path and all directories are
   * included in the returned set of paths.
   *
  ...
  /**
   * Will recursively list the directory or add the path without throwing any exceptions.
   *
