...
/**
 * A simple work queue implementation based on the IBM developerWorks article by Brian Goetz. It is
 * up to the user of this class to keep track of whether there is any pending work remaining.
 *
