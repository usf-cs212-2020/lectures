...
/**
 * This class demonstrates how to use the {@link Path} class to get basic path information.
 *
...
public class PathDemo {
  ...
  public static void main(String[] args) throws IOException {
    ...
    /*
     * Relative paths are nice for users. It is much easier as a user to enter a relative path
     * instead of an absolute path. However, these paths are not as useful for our programs. Notice
     * below how much information is missing.
     */
    Path relativeDirectory = Path.of("."); // try ".", "..", and "~"
    pathDetails(relativeDirectory);

    /*
     * Also note that converting to an absolute path doesn't solve all the problems. There is a
     * extra "." at the end of the path, so there are still some redundant and unnecessary elements
     * in our path.
     */
    ...
    /*
     * To convert the path into a format more useful for our programs, use the toAbsolutePath() and
     * normalize() methods. This will convert the path to an absolute path, and then remove the
     * redundant parts of the path. Now, notice how we are able to get more useful details about our
     * path object.
     */
    ...
    /*
     * You can also easily combine paths together without having to worry about different path
     * separators on different systems (like "/" on Unix, Linux, or Mac systems and "\" on Windows
     * systems).
     */
    ...
    /*
     * Since Path objects contain hierarchy, we can also get different elements of that hierarchy.
     */
    ...
    /*
     * We can use the Files utility class to get information from the file system about the path in
     * question.
     */
