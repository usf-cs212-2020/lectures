 ...
 * 1000. </blockquote>
 *
 * This example illustrates the reusable and generalized approach, but this time using streams and
 * lambda functions that were introduced in Java 8.
 */
public class Problem1e {
  ...
  /*
   * This example is the same as before, except this time showing off the new features in Java. We
   * will slowly introduce these features throughout the semester.
   */
}
