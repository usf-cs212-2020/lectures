...
public class MirrorDriver {
  ...
  /**
   * Creates an empty bounded buffer, and starts the producer and consumer threads.
   */
  public MirrorDriver() {
  ...
  /**
   * Produces elements by scanning the console for user input. When found, splits the input into
   * individual words and adds each word to the bounded buffer.
   */
  ...
  /**
   * Consumes elements from the bounded buffer, and outputs each element to the console in reverse.
   */
