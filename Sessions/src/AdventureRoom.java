/**
 * Represents all of the "rooms" available for a simple adventure game. Also an example of a more
 * complex enum type.
 *
 * @see AdventureServer
...
public enum AdventureRoom {
  ...
  /**
   * Tests whether we can move in the specified direction from the current room, based on the room's
   * ordinal value.
   *
