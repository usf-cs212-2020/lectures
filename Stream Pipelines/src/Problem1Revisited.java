 ...
 * 1000. </blockquote>
 *
 * This example illustrates the most straight-forward approach to solve this problem and then the
 * stream version of this solution.
 */
public class Problem1Revisited {
  ...
  /*
   * An advanced way to create a generalized solution of this problem using lambdas and streams.
   */
