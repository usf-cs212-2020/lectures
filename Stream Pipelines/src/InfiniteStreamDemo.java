...
public class InfiniteStreamDemo {
  ...
  /**
   * Reverses the digits provided. For example, 12345 becomes 54321. Works for both positive and
   * negative numbers.
   *
  ...
  /**
   * Outputs palindromic squares until the results get too large and cause an overflow.
   *
   * @param args unused
  ...
  public static void main(String[] args) throws ArithmeticException {
    ...
    IntStream.iterate(1, i -> i + 1)
        ...
        .filter(i -> i == reverse(i)).forEach(System.out::println);
