...
public class StringSorter {
  ...
  public static void main(String[] args) {
    ...
    Collections.addAll(words,
        "ant", "AARDVARK", "Bee", "capybara", "deer", "elk", "elephant",
        "FOX", "gecko", "hippopatamus");
    ...
    // http://hg.openjdk.java.net/jdk/jdk13/file/0368f3a073a9/src/java.base/share/classes/java/lang/String.java#l1233
    Collections.shuffle(words);
