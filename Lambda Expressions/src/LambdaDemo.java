/**
 * Demonstrates one difference (namely the use of the {@code this} keyword) between lambda
 * expressions and traditional classes, static nested classes, inner classes, and anonymous classes.
 *
 * @see SimpleInterface
 * @see SimpleClass
 *
...
public class LambdaDemo {
  ...
  public static void main(String[] args) {
    ...
    /*
     * Since we are in a static method, there is no "this" context for the lambda expression below
     * to reference. Remember, lambda expressions are NOT quite objects (and do not create a new
     * scope)!
     */
